...
namespace ScarIntel.BrokerService {
    ...
    public interface ServerService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="BrokerService/ServerService/GetAllDocumentPerson", ReplyAction="BrokerService/ServerService/GetAllDocumentPersonResponse")]
        [System.ServiceModel.FaultContractAttribute(typeof(ScarIntel.BrokerService.IllegalAccess), Action="BrokerService/ServerService/GetAllDocumentPersonIllegalAccessFault", Name="IllegalAccess", Namespace="http://schemas.datacontract.org/2004/07/Domain.FaultContract")]
        [System.ServiceModel.FaultContractAttribute(typeof(ScarIntel.BrokerService.ServerError), Action="BrokerService/ServerService/GetAllDocumentPersonServerErrorFault", Name="ServerError", Namespace="http://schemas.datacontract.org/2004/07/Domain.ServiceContract")]
        ScarIntel.BrokerService.Document[] GetAllDocumentPerson(int idperson);
        
        [System.ServiceModel.OperationContractAttribute(Action="BrokerService/ServerService/GetAllDocumentPerson", ReplyAction="BrokerService/ServerService/GetAllDocumentPersonResponse")]
        System.Threading.Tasks.Task<ScarIntel.BrokerService.Document[]> GetAllDocumentPersonAsync(int idperson);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="BrokerService/ServerService/GetNumberOfParticipants", ReplyAction="BrokerService/ServerService/GetNumberOfParticipantsResponse")]
        System.Threading.Tasks.Task<int> GetNumberOfParticipantsAsync(int regist);
        ...
        void InsertPerson(ScarIntel.BrokerService.Person val);
        
        [System.ServiceModel.OperationContractAttribute(Action="BrokerService/ServerService/InsertPerson", ReplyAction="BrokerService/ServerService/InsertPersonResponse")]
        System.Threading.Tasks.Task InsertPersonAsync(ScarIntel.BrokerService.Person val);
    ...
    public partial class ServerServiceClient : System.ServiceModel.ClientBase<ScarIntel.BrokerService.ServerService>, ScarIntel.BrokerService.ServerService {
        ...
        public ScarIntel.BrokerService.Document[] GetAllDocumentPerson(int idperson) {
            return base.Channel.GetAllDocumentPerson(idperson);
        }
        
        public System.Threading.Tasks.Task<ScarIntel.BrokerService.Document[]> GetAllDocumentPersonAsync(int idperson) {
            return base.Channel.GetAllDocumentPersonAsync(idperson);
        }
        ...
        public int GetNumberOfParticipants(int regist) {
            return base.Channel.GetNumberOfParticipants(regist);
        }
        
        public System.Threading.Tasks.Task<int> GetNumberOfParticipantsAsync(int regist) {
            return base.Channel.GetNumberOfParticipantsAsync(regist);
        }
        ...
        public void InsertPerson(ScarIntel.BrokerService.Person val) {
            base.Channel.InsertPerson(val);
        }
        
        public System.Threading.Tasks.Task InsertPersonAsync(ScarIntel.BrokerService.Person val) {
